//acts as our homepage page, where the user keys in the user name and room name is joining.
...
//we take the user name and room name and call the function socket.emit("joinRoom") and pass the username and roomname.
